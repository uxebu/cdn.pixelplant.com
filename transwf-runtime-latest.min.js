...
b.length&&b.length(d.length);j.gotoFrame(b,0,c)},removeCharacter:function(a,b){if(a){var c=a.__flash__,d=c.parent;d?(d.removeChild(c),b&&(d[b]=null)):a.remove()}},connectClipActions:function(a,b){var c="drag,keydown,keypress,keyup,mouseout,mouseover,pointerdown,pointermove,pointerup".split(","),d;for(d in b)for(var g=0,l=b[d].length;g<l;g++){var f=a.__flash__;-1<c.indexOf(d)&&(f.mouseEnabled=!0);a.on(d,tools.hitch(f,b[d][g]))}},_dictionary:F};n.module$exports=j;n.module$exports&&(n=n.module$exports);
var s={},U=n,G=p,H={constructChildren:function(a,b){var c,d=a.swf;if(d&&d.newChildren){for(var g=d.newChildren,l=0,f;f=g[l];l+=1){var h=f.clipDepth,j=f.bonsaiObject,i=j.__flash__,k=f.objectName;h?(c=new bonsai.Group,c.attr("data","clip"),a.displayList.placeSwfClip(j,c,f.depth,h,b,i)):a.displayList.placeSwfObject(j,f.depth,b,i);i&&(k&&(i[G().expando].name=k),i.constructor(),k&&i[G().expando].raw.attr("data","objectName = "+k));k&&((c=Object.getOwnPropertyDescriptor(b,k))&&!c.configurable?(b[k]=i,b[k.toLowerCase()]=
i):(Object.defineProperty(b,k,{configurable:!0,writable:!0,value:i}),Object.defineProperty(b,k.toLowerCase(),{configurable:!0,writable:!0,value:i})))}d.newChildren=null}},"goto":function(a,b,c,d){U.gotoFrame(a,b,d)&&H.constructChildren(a,c)}};s.module$exports=H;s.module$exports&&(s=s.module$exports);var t={},V=n,W=s.constructChildren;t.module$exports={playFirstFrame:function(a,b){var c=a.__flash__;b.vmToplevel.global.stage.addChildAt(c,0);c.constructor()},playFrame:function(a,b){for(var c=V.playSwfFrame(a,
b),d=0,g;g=c[d];d+=1)W(g,g.__flash__)}};t.module$exports&&(t=t.module$exports);var p={},z=r,Q=q,B=s,C=t,A=n,q={playSwf:function(a,b,c,d){var g=a.bonsai.stage;g.setBackgroundColor(c);N(a);g.options.flashConfig||(g.options.flashConfig={});var j={};d.forEach(function(a){"Sound"==a.type&&(j[a.name]=a.path)});g.options.flashConfig.exportAssets={sounds:j};g.toplevel=a.vmToplevel;c=z.getInstance(0,a,A.initSprite);O(a);P(d,g,c,a,b);return c},preprocessDictionary:o.preprocessDictionary,_registerSymbolClass:y},
o=Function("return this")();o.exports=o.exports||{};o.exports.transwf=q;p.module$exports=q;p.module$exports&&(p=p.module$exports)})();
